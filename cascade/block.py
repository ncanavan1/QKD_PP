class Block:
    ...
    def __init__(self, key, shuffle, start_index, end_index, parent_block, power_params):
        """
        ...
        self._current_parity, pwr_trace = shuffle.calculate_parity(key, start_index, end_index,power_params)

        # We don't yet know the correct parity for this block.
        self._correct_parity = None

    @staticmethod
    def create_covering_blocks(key, shuffle, block_size,power_params):
        """
        ...
        while remaining_bits > 0:
            ...
            block = Block(key, shuffle, start_index, end_index, None,power_params)
            blocks.append(block)
    ...
    def create_right_sub_block(self):
        ...
        """
        middle_index = self._start_index + (self._end_index - self._start_index + 1) // 2
        self._right_sub_block = Block(self._key, self._shuffle, middle_index, self._end_index, self,self._power_params)
        return self._right_sub_block
