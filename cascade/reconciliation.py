...
class Reconciliation:
    ...
    def __init__(self, algorithm_name, classical_channel, noisy_key, estimated_bit_error_rate, power_params):
        """
    ...
    def reconcile(self):
        ...
        return self._reconciled_key, self.Eves_traces
    ...
    def _service_pending_ask_correct_parity(self):
        ...
        correct_parities, self.Eves_traces = self._classical_channel.ask_parities(ask_parity_blocks,self.Eves_traces)
    ...
    def _one_normal_cascade_iteration(self, iteration_nr):
        ...
        blocks = Block.create_covering_blocks(self._reconciled_key, shuffle, block_size,self._power_params)
    ...
    def _one_biconf_iteration(self):
        ...
        chosen_block = Block(self._reconciled_key, shuffle, 0, mid_index, None, self._power_params)
        if cascade:
