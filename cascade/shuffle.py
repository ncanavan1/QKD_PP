...
class Shuffle:
    ...
    def calculate_parity(self, key, shuffle_start_index, shuffle_end_index,power_params):
        """
        ...
        for shuffle_index in range(shuffle_start_index, shuffle_end_index):
            ...
            if key.get_bit(key_index):
                parity = 1 - parity
            B = key.get_bit(key_index)
            pwr = noise_modelling.simulate_xor_trace_general(A, B, power_params)
